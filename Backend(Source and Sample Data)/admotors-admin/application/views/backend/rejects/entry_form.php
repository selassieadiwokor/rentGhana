	...
	<div class="card card-info">
        ...
        <div class="card-body">
             	...
             	<div class="col-md-6">
            		<div class="form-group">
						...
						<?php echo form_input( array(
							'name' => 'wallpaper_name',
							'value' => set_value( 'wallpaper_name', show_data( @$reject->wallpaper_name ), false ),
                  	...
                  	<div class="form-group">
						...
						<?php echo form_input( array(
							...
							'value' => set_value( 'wallpaper_search_tags', show_data( @$reject->wallpaper_search_tags ), false ),
							'class' => 'form-control form-control-sm',
					...
					<div class="form-group">
						...
						<?php echo form_input( array(
							'name' => 'point',
							'value' => set_value( 'point', show_data( @$reject->point ), false ),
							'class' => 'form-control form-control-sm',
					...
					<?php
						$conds = array( 'img_type' => 'wallpaper', 'img_parent_id' => $reject->wallpaper_id );
					...
					<div class="form-group">
						...
						<?php
							...
							echo form_dropdown(
								'color_id',
								$options,
								set_value( 'color_id', show_data( @$reject->color_id), false ),
					...
					<div class="form-group">
						...
						<select class="form-control" name="modes" id="modes" value="<?php echo $value; ?>" disabled>
							...
							<?php
	    						...
	    						if($reject->is_portrait == 1) {
		    						echo '<option value="1" selected>is_portrait</option>';
		    					} else if( $reject->is_landscape == 1){
            ...
            <div class="form-group" style="background-color: #edbbbb; padding: 20px;">
						<label>
							<?php echo get_msg('select_status')?>
						</label>
