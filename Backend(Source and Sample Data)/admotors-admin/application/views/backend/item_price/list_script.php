...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_price_label' ),
		'message' => get_msg( 'price_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'price_yes_all_label' ),
		'no_only_btn' => get_msg( 'price_no_only_label' )
	);
