...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_blog_label' ),
		'message' =>  get_msg( 'blog_delete_confirm_message' ),
		'no_only_btn' => get_msg( 'blog_no_only_label' )
	);
	
	$this->load->view( $template_path .'/components/feed_delete_confirm_modal', $data );
?>