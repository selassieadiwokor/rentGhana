        ...
        <div class="card-body">
            <div class="row">
              	<div class="col-md-6">
					...
					<!-- /.form-group -->
		            <div class="form-group">
						<label><?php echo get_msg('terms_label')?>
							<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('pravicypolicy_label')?>">
								<span class='glyphicon glyphicon-info-sign menu-icon'>
							</a>
						</label>
						<textarea class="form-control" name="privacypolicy" placeholder="Pravicy Policy" rows="5"><?php echo $about->privacypolicy; ?></textarea>
					</div>
		            ...
		            <div class="form-group">
						...
						<textarea class="form-control" name="GDPR" placeholder="GDPR Content" rows="5"><?php echo $about->GDPR; ?></textarea>
					</div>
		            ...
		            <div class="form-group">
						...
						<textarea class="form-control" name="safety_tips" placeholder="Safety Tips" rows="5"><?php echo $about->safety_tips; ?></textarea>
					</div>
