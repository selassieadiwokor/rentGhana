...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_manu_label' ),
		'message' => get_msg( 'manu_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'manu_yes_all_label' ),
		'no_only_btn' => get_msg( 'manu_no_only_label' )
	);
